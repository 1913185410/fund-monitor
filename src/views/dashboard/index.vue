  ...
  sectorChart.setOption(
    {
      ...
      visualMap: {
        ...
        max: maxAbs,
        dimension: 1,
        inRange: { color: ['#00b42a', '#9ff0c1', '#f7f8fa', '#ffb8a8', '#f53f3f'] },
      },
      series: [
        {
          type: 'treemap',
  ...
  pieChart.setOption(
    {
      ...
      legend: { type: 'scroll', bottom: 0, textStyle: { fontSize: 11 }, itemWidth: 10, itemHeight: 10 },
      title: {
        text: `${fmtMoney(pieTotal.value)}\n总持仓`,
        left: 'center',
        top: '36%',
        textAlign: 'center',
        textStyle: { fontSize: 13, color: '#86909c', lineHeight: 18, fontWeight: 'normal' },
      },
      series: [
        {
          type: 'pie',
  ...
  contributionChart.setOption(
    {
      ...
      yAxis: { type: 'category', data: list.map((d) => d.name).reverse(), axisLabel: { fontSize: 11 } },
      series: [
        {
          type: 'bar',
          barWidth: '58%',
  ...
  corrChart.setOption(
    {
      ...
      xAxis: { type: 'category', data: labels, splitArea: { show: true }, axisLabel: { fontSize: 11, rotate: 40 } },
    ...
    <div class="dash-grid">
      ...
      <a-card :bordered="false" class="dash-card">
        ...
        <a-spin :loading="sectorLoading">
          <div v-if="sectorEmpty" class="chart-empty">暂无板块数据</div>
